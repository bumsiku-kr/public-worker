...
import { NotFoundError, ValidationError, convertError } from '../utils/errors.js';
...
export async function handleGetPosts(request, env, ctx, params, user) {
  try {
    ...
    const sortErrors = validateSorting(sortParam, ['createdAt', 'updatedAt', 'views', 'title']);
